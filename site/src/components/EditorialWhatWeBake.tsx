...
function ScalableImage({ src, alt }: { src: string; alt: string }) {
  ...
  return (
    <div className="h-[56vw] w-full max-w-full overflow-hidden md:aspect-square md:h-auto md:min-h-0">
      <div ref={ref} className="relative h-full min-h-[160px] w-full md:min-h-0">
...
export function EditorialWhatWeBake() {
  ...
  return (
    <section id="menu" className="scroll-mt-24 bg-[var(--bg-primary)] md:scroll-mt-28">
      <div className="mx-auto max-w-[1600px]">
        <div className="grid grid-cols-12 gap-x-6 gap-y-0 md:gap-x-6">
          ...
          <div className="col-span-12 flex flex-col justify-center px-[var(--page-padding-x)] py-10 md:col-span-7 md:px-0 md:py-[60px] md:pl-12 md:pr-[var(--page-padding-x)]">
            <p
              ref={labelRef}
            ...
            <h2
              ref={headingRef}
              className="font-heading mb-5 max-w-xl text-[clamp(36px,4vw,64px)] font-extralight leading-[1.05] tracking-[-0.02em] text-[var(--text-primary)]"
            >
              Pies. Pastries. Coffee. Cake.
            </h2>
            <p ref={bodyRef} className="mb-7 max-w-md text-[15px] leading-[1.7] text-[var(--text-secondary)]">
          ...
          <div
            id="menu-explore"
            className="col-span-12 grid w-full max-w-full grid-cols-2 gap-4 px-[var(--page-padding-x)] pb-[var(--section-padding-y)] md:grid-cols-3 md:gap-x-6 md:gap-y-3"
          >
            <article className="min-w-0">
              ...
              />
              <h3 className="font-heading mt-3 text-[15px] font-medium text-[var(--text-primary)]">
                Steak &amp; Cheese Pie
              </h3>
            ...
            <article className="min-w-0">
              ...
              />
              <h3 className="font-heading mt-3 text-[15px] font-medium text-[var(--text-primary)]">Croissant</h3>
              <p className="mt-1 text-[13px] leading-relaxed text-[var(--text-muted)]">
            ...
            <article className="col-span-2 min-w-0 md:col-span-1">
              <ScalableImage
                ...
                alt="Cake slice"
              />
              <h3 className="font-heading mt-3 text-[15px] font-medium text-[var(--text-primary)]">Cake &amp; slices</h3>
              <p className="mt-1 text-[13px] leading-relaxed text-[var(--text-muted)]">
